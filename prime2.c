...
//int Events[NUM_EVENTS] = {PAPI_TOT_INS, PAPI_TOT_CYC, PAPI_L1_TCM, PAPI_LST_INS, PAPI_L2_TCM}, EventSet = PAPI_NULL;

int Events[NUM_EVENTS] = {PAPI_LST_INS, PAPI_TLB_DM, PAPI_TLB_IM, PAPI_BR_CN, PAPI_BR_MSP}, EventSet = PAPI_NULL;
...
int main(int argc,char **argv)
{
    ...
    printf("TLB miss rate       : %.4lf\n", (values[1] + values[2]) * 1.0 / values[0]);
    printf("BR miss predict rate: %.4lf\n", values[4] * 1.0 / values[3]);
